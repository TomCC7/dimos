...
all_blueprints = {
    ...
    "coordinator-teleop-piper-with-policy": "dimos.control.blueprints.teleop:coordinator_teleop_piper_with_policy",
...
all_modules = {
    ...
    "episode-boundary": "dimos.teleop.quest.episode_boundary.EpisodeBoundary",
    ...
    "policy-node": "dimos.manipulation.policy.node.PolicyNode",
    ...
    "rerun-data-recorder": "dimos.visualization.rerun.recorder.RerunDataRecorder",
    ...
    "rollout-toggle": "dimos.manipulation.policy.rollout_toggle.RolloutToggle",
