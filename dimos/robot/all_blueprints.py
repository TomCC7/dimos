...
all_blueprints = {
    ...
    "teleop-quest-openarm-rerun": "dimos.teleop.quest.blueprints:teleop_quest_openarm_rerun",
...
all_modules = {
    ...
    "open-arm-bimanual-pink-ik-desired-state": "dimos.control.pink_ik_visualization.OpenArmBimanualPinkIkDesiredState",
