...
Define the no-hardware XArm7 Quest teleop preview behavior, where mock coordinator state drives a read-only Meshcat robot visualization while MuJoCo remains the explicit physics simulation path.
